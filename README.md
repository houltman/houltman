...
- [Agente / Bot de WhatsApp Inteligente para Automatización Comercial](https://youtu.be/Om1Eqp_CH9g)
  - Tecnología Empleada: Integración avanzada utilizando la Evolution API para la conexión con la red de WhatsApp, Laravel (PHP)     para el backend de alta velocidad, y modelos de lenguaje avanzados Gemini (Google Vertex AI) para el procesamiento de lenguaje      natural y la IA conversacional.
